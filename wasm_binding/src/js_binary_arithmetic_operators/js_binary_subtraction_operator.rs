...
#[wasm_bindgen(js_name = "BinarySubtractionOperator")]
pub(crate) struct JsBinarySubtractionOperator;

impl JsBinarySubtractionOperator {
    const JS_NAME: &'static str = "BinarySubtractionOperator";
    const OPERATOR: BinaryArithmeticOperator =
        BinaryArithmeticOperator::Subtraction;
}

#[wasm_bindgen(js_class = BinarySubtractionOperator)]
impl JsBinarySubtractionOperator {
    #[allow(dead_code)]
    ...
    pub fn new() -> Result<JsBinarySubtractionOperator, JsValue> {
...
impl GetJsName for JsBinarySubtractionOperator {
