...
#[wasm_bindgen(js_name = "BinaryLessThanOperator")]
pub(crate) struct JsBinaryLessThanOperator;

impl JsBinaryLessThanOperator {
    const JS_NAME: &'static str = "BinaryLessThanOperator";
    const OPERATOR: BinaryComparisonOperator =
        BinaryComparisonOperator::LessThan;
}

#[wasm_bindgen(js_class = BinaryLessThanOperator)]
impl JsBinaryLessThanOperator {
    #[allow(dead_code)]
    ...
    pub fn new() -> Result<JsBinaryLessThanOperator, JsValue> {
...
impl GetJsName for JsBinaryLessThanOperator {
