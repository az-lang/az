...
pub(crate) struct PyBinaryArithmeticOperation(
    BinaryArithmeticOperation<OwnedString>,
);
        ...
        Ok((
            PyTuple::new_bound(
                ...
                [
                    ...
                    .into_py(py),
                    BinaryArithmeticOperatorWrapper::from(self.0.operator)
                        .into_py(py),
                ],
            ),
            kwargs,
...
impl From<BinaryArithmeticOperation<OwnedString>>
    for PyBinaryArithmeticOperation
{
    fn from(value: BinaryArithmeticOperation<OwnedString>) -> Self {
        Self(value)
    }
}
...
impl Repr for BinaryArithmeticOperation<OwnedString> {
