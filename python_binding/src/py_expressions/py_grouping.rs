...
pub(crate) struct PyGrouping(Grouping<OwnedString>);
...
impl From<Grouping<OwnedString>> for PyGrouping {
    fn from(value: Grouping<OwnedString>) -> Self {
        Self(value)
    }
}

impl From<PyGrouping> for Grouping<OwnedString> {
...
impl Repr for Grouping<OwnedString> {
