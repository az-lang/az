...
pub(crate) struct PyFunctionDefinition(FunctionDefinition<OwnedString>);
...
impl PyFunctionDefinition {
    ...
    open_parenthesis_position, comma_positions,
    close_parenthesis_position, arrow_position, opener_fillers,
    open_parenthesis_fillers, comma_fillers, close_parenthesis_fillers,
    arrow_fillers,
    ))]
    fn new(
        parameters: Vec<PyAnnotatedIdentifier>,
    ...
    #[getter]
    fn parameters(&self) -> Vec<PyAnnotatedIdentifier> {
...
impl From<FunctionDefinition<OwnedString>> for PyFunctionDefinition {
    fn from(value: FunctionDefinition<OwnedString>) -> Self {
        Self(value)
    }
}

impl From<PyFunctionDefinition> for FunctionDefinition<OwnedString> {
...
impl Repr for FunctionDefinition<OwnedString> {
