...
#[pyclass(
    module = "az.parsing", name = "FunctionType", extends = PyExpression,
    frozen
)]
pub(crate) struct PyFunctionType(FunctionType<OwnedString>);
...
impl PyFunctionType {
    ...
    #[new]
    #[pyo3(signature = (
    parameters, return_type, /, *, open_parenthesis_position, comma_positions,
    close_parenthesis_position, operator_position, open_parenthesis_fillers,
    comma_fillers, close_parenthesis_fillers, operator_fillers,
    ))]
    fn new(
        ...
        PyExpression::new().add_subclass(Self(FunctionType {
...
impl From<FunctionType<OwnedString>> for PyFunctionType {
    fn from(value: FunctionType<OwnedString>) -> Self {
        Self(value)
    }
}

impl From<PyFunctionType> for FunctionType<OwnedString> {
    fn from(value: PyFunctionType) -> Self {
        value.0
    }
}

impl IntoPy<PyObject> for PyFunctionType {
...
impl Repr for FunctionType<OwnedString> {
    fn repr(&self, py: Python<'_>) -> PyResult<String> {
        Ok(format!(
            "{}({}, {}, open_parenthesis_position={}, comma_positions={}, close_parenthesis_position={}, operator_position={}, open_parenthesis_fillers={}, comma_fillers={}, close_parenthesis_fillers={}, operator_fillers={})",
            PyFunctionType::NAME,
...
impl Repr for PyFunctionType {
    fn repr(&self, py: Python<'_>) -> PyResult<String> {
        self.0.repr(py)
    }
}

impl_unordered_rich_cmp_for_derived_py_class!(PyFunctionType, PyExpression);
