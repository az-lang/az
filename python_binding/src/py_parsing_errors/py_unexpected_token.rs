...
pub(crate) struct PyUnexpectedToken(UnexpectedToken<TokenOwnedString>);
...
impl From<UnexpectedToken<TokenOwnedString>> for PyUnexpectedToken {
    fn from(value: UnexpectedToken<TokenOwnedString>) -> Self {
        Self(value)
    }
}

impl Repr for UnexpectedToken<TokenOwnedString> {
