...
pub(crate) struct PyMissingSemicolon(MissingSemicolon<TokenOwnedString>);
...
impl From<MissingSemicolon<TokenOwnedString>> for PyMissingSemicolon {
...
impl Repr for MissingSemicolon<TokenOwnedString> {
