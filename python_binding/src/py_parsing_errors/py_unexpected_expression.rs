...
pub(crate) struct PyUnexpectedExpression(UnexpectedExpression<OwnedString>);
...
impl From<UnexpectedExpression<OwnedString>> for PyUnexpectedExpression {
    fn from(value: UnexpectedExpression<OwnedString>) -> Self {
        Self(value)
    }
}

impl Repr for UnexpectedExpression<OwnedString> {
