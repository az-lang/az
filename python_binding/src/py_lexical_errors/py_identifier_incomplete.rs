...
pub(crate) struct PyIdentifierIncomplete(
    IdentifierIncomplete<TokenOwnedString>,
);
...
impl From<IdentifierIncomplete<TokenOwnedString>> for PyIdentifierIncomplete {
...
impl Repr for IdentifierIncomplete<TokenOwnedString> {
