...
pub(crate) struct PyUnexpectedCharacter(UnexpectedCharacter<TokenOwnedString>);
...
impl From<UnexpectedCharacter<TokenOwnedString>> for PyUnexpectedCharacter {
...
impl Repr for UnexpectedCharacter<TokenOwnedString> {
